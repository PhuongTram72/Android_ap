        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            tru.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    else if (Character.isDigit(input.getText().charAt(input.getText().length() - 1)) || input.getText().charAt(input.getText().length() - 1) == '/' || input.getText().charAt(input.getText().length() - 1) == 'x')
                        input.setText(input.getText() + "-");
                }
            });
                ...
                switch (cArray[i]) {
                    ...
                    case 'x':
                        ...
                        if (i < cArray.length - 1)
                            if (cArray[i + 1] == '-' && i + 1 < cArray.length - 1) {
